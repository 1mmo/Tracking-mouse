...
# The first parameter is the number of variables 
# tracked (or predicted) by the Kalman filter
# We have 4: x, y, x-velocity, y-velocity
# The second parameter is the number of variables provided 
# to the Kalman filter as measurements. We have 2D
kalman = cv2.KalmanFilter(4, 2)
# We also initialize several matrices that describe 
# the relationships among all these variables.
...
def on_mouse_moved(event, x, y, flags, param):
    ...
    if last_measurement is None:
        ...
        # Trece the path of the prediction in red.
